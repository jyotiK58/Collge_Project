...
<?php  
$oid=$_GET['oid'];
$query=mysqli_query($con,"select tblorderaddresses.OrderTime,tblfood.Image,tblfood.ItemName, tblfood.ItemQty, tblfood.Weight,tblfood.ItemPrice,tblorders.FoodId,tblorders.OrderNumber, tblorders.discount_amount from tblorders 
